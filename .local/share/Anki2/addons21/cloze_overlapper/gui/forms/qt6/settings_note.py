...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.sb_after = QtWidgets.QSpinBox(parent=Dialog)
        ...
        self.cb_ncf = QtWidgets.QCheckBox(parent=Dialog)
